    ...
    <main className="min-h-screen bg-zinc-950 text-zinc-200">
      <div className="mx-auto max-w-3xl p-6">
        ...
        <Section id="corpus" title="How the corpus was altered">
          ...
          <p className="mb-2">
            So what you download from here is a display copy. Print from the
            designer&rsquo;s original, which the source link in a model&rsquo;s
            credits leads to.
          </p>
          <p>
        ...
        <Section id="privacy" title="Privacy">
          <p>
            ...
            script runs on these pages. What you change while browsing — which
            models you have turned, your search options, whether you dismissed
            the introduction — is kept in this browser&rsquo;s own storage and
            is sent nowhere.
          </p>
        </Section>
        ...
        <Section id="technical" title="Under the hood">
          <p className="mb-2">
            ...
            embeddings of a render of every model, so a typed phrase and a
            picture of a model are compared in one embedding space — which is
            why a description finds things whose file names say nothing.
          </p>
          <p className="mb-2">
            ...
            against text prompts for upright and toppled, averaged with the
            geometry vote; it runs on every model, because a figure with no flat
            base at all — leaping, flying, based on a rock — is exactly where
            geometry is confidently wrong. The third asks a vision-language
            model, and only about the remainder geometry cannot settle.
          </p>
          <p>
        ...
        <Section id="limitations" title="What the search does badly">
          ...
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              elves and robed spellcasters; the one kit in this corpus that
              actually names a vampire sits well down it, and the ghouls further
              still. Each of those is a fair reading of part of what a vampire
            ...
            <li>
              ...
              Ask for <em>an elf carrying an orb</em> and elves with nothing in
              their hands come back beside a human warlock holding one, mixed in
              among the elven mages that answer the whole phrase. A hit meeting
              more of the query usually scores higher, so the full matches tend
              to lead and the partial ones trail.
            </li>
          </ul>
        </Section>
