...
- [x] 1.1 `App.tsx` `noteFramingChanged`: the two unknown-before-state exits re-derive the
      ...
      *(landed 2026-09-11 as 7a5d593, ahead of this record)*
- [x] 1.2 Cells in `bulkJobSurfaces.test.tsx`: an orbit on a ready tile moves the count by
      ...
      fails; restore the bare `return` → the second fails *(7a5d593's report)*

## 2. Land it

- [x] 2.1 Suites and typecheck green on merged main *(client 945/945 at 7a5d593; 952/952 at
      a61a484 with the pose work on top)*
