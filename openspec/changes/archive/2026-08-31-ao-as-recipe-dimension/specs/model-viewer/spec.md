...
> Every scenario title is kept; "Toggling occlusion off for performance" and "Handoff
> stays seamless" have bodies rewritten for thumbnails that follow the preference.
> `remove-axis-lighting` rewrites a sibling requirement in this file; hard ordering, no
> overlap in requirement titles.
