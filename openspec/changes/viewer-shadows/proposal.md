...
(`model-thumbnails` is unchanged at the spec level — the rig-version invalidation requirement rim-lights adds already covers this change's `RIG_VERSION` bump.)
