# thumbnail-jobs Specification

## Purpose
Bulk thumbnail work — warming a subtree or the whole library to fully thumbnailed, and
giving up the framings stored beneath a folder — as explicit, scoped, cancellable jobs
